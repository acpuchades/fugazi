...
#[cfg(feature = "live")]
pub use live::{CoinbaseWallet, KrakenWallet, OkxWallet};
pub use market::{
...
pub use snapshot::{Selector, Snapshot, StreamId, Symbol, stream, symbol};
...
pub mod prelude {
    ...
    pub use crate::snapshot::{Selector, Snapshot, StreamId, Symbol, stream, symbol};
