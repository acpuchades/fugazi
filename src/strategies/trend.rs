...
pub fn ma_crossover<Sym: Clone + PartialEq + std::hash::Hash + Eq + 'static>(symbol: Sym, fast: usize, slow: usize) -> SingleAssetStrategy<Sym> {
...
pub fn macd_crossover<Sym: Clone + PartialEq + std::hash::Hash + Eq + 'static>(
    symbol: Sym,
    fast: usize,
    slow: usize,
    signal: usize,
...
pub fn macd_zero_cross<Sym: Clone + PartialEq + std::hash::Hash + Eq + 'static>(
    symbol: Sym,
    fast: usize,
    slow: usize,
    signal: usize,
...
pub fn donchian_breakout<Sym: Clone + PartialEq + std::hash::Hash + Eq + 'static>(symbol: Sym, period: usize) -> SingleAssetStrategy<Sym> {
...
pub fn triple_ma<Sym: Clone + PartialEq + std::hash::Hash + Eq + 'static>(
    symbol: Sym,
    fast: usize,
    mid: usize,
    slow: usize,
...
pub fn bollinger_breakout<Sym: Clone + PartialEq + std::hash::Hash + Eq + 'static>(symbol: Sym, period: usize, k: Real) -> SingleAssetStrategy<Sym> {
