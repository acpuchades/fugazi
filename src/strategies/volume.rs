...
pub fn obv_trend<Sym: Clone + PartialEq + 'static>(symbol: Sym, ma_period: usize) -> SingleAssetStrategy<Sym> {
...
pub fn vwap_reversion<Sym: Clone + PartialEq + 'static>(symbol: Sym) -> SingleAssetStrategy<Sym> {
...
pub fn chaikin_ad_trend<Sym: Clone + PartialEq + 'static>(symbol: Sym, ma_period: usize) -> SingleAssetStrategy<Sym> {
